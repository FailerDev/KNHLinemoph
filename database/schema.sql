...
'flex',
'{"version":1,"size":"mega","theme":{"primary":"#B91C1C","background":"#FFFFFF"},"blocks":[{"id":"h","type":"header","title":"🚨 แจ้งเตือนผู้ป่วยเฝ้าระวัง","subtitle":"{org_name} • {vstdate_th} {vsttime}"},{"id":"k1","type":"kpi","columns":1,"cells":[{"label":"HN","value":"{hn}","tone":"muted"}]},{"id":"k2","type":"kpi","columns":2,"cells":[{"label":"ICD-10","value":"{icd10}","tone":"danger"},{"label":"อายุ","value":"{age}","unit":"ปี","tone":"info"}]},{"id":"l","type":"list","rows":[{"label":"ชื่อผู้ป่วย","value":"{pt_name}"},{"label":"โรค","value":"{icd10_name}"}]},{"id":"n","type":"note","text":"CC: {cc}","tone":"warn"},{"id":"v","type":"list","heading":"สัญญาณชีพ","rows":[{"label":"อุณหภูมิ","value":"{temperature}"},{"label":"ชีพจร","value":"{pulse}"},{"label":"RR","value":"{rr}"},{"label":"ความดัน","value":"{bps}/{bpd}"}]},{"id":"f","type":"note","text":"เบอร์โทร {hometel} • ที่อยู่ {informaddr}","tone":"muted"}]}',
